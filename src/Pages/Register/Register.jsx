    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-50 to-pink-100">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 md:p-10 border border-purple-200 transform transition-all duration-300 hover:shadow-xl hover:scale-[1.005]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div> {/* This div now contains only the label and the relative wrapper */}
            <label htmlFor="password" className="block text-lg font-semibold text-gray-700 mb-2">Password</label>
            <div className="relative"> {/* This div is now the relative container for input and button */}
              <input
          ...
          {/* FB Name Input */}
          <div>
            <label htmlFor="fbName" className="block text-lg font-semibold text-gray-700 mb-2">Facebook Name</label>
            <input
              type="text"
              id="fbName"
              name="fbName"
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-8 max-w-sm w-full text-center transform transition-all duration-300 scale-100 opacity-100">
            ...
            <p className="text-gray-600 mb-6">Your account has been created. Please proceed to login.</p>
            <button
